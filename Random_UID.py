...
class Main:
	def __init__(self):
		...
		os.system("clear")
		jalan(" ••• please follow my Facebook page author :) thank you")
		os.system("https://www.facebook.com/profile.php?id=100092174587959")
		time.sleep(4)
		os.system("clear")
		os.system("figlet hossain")
		print("\n  ( Programmed By Hossain Meer )") 
		print("\n  ( Facebook : Hossain Meer'hamii )") 
		print("\n  ( WhatsApp +923155912839 )") 
		print(" ( https://github.com/hasan5636)\n") 
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print(" [•] GITHUB : https://github.com/Hasan5607")
		exit()
	else:
		Main()
